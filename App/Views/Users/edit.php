    ...
    <div class="container">
        ...
        <form class="row my-5 was-validated" method="post">
            ...
            <div class="col-md-4 form-group my-3">
                ...
                <input type="text" name="birth_date" id="birth_date" class="form-control" placeholder="" max="<?php echo $max_date; ?>" min="<?php echo $min_date; ?>" value="<?php if ($user) {
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var options = group_id.options;
        for (i = 0; i < options.length; i++) {
            var department_id = options[i].dataset.department_id;
            if (department_id == <?php echo $user->department_id ?>) {
